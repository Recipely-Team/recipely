...
export const tr: Translations = {
  ...
  errors: {
    ...
    importInvalidUrl: {
      ...
      body: 'Geçerli bir Instagram ya da tarif sitesi bağlantısı yapıştırıp tekrar dene.',
      short: 'Geçerli bir Instagram ya da tarif sitesi bağlantısı yapıştır',
    },
    importNotInstagram: {
      title: 'Oradan içe aktaramıyoruz',
      body: 'Instagram videolarından ve tarif sitelerinden içe aktarabiliyoruz.',
  ...
  importRecipe: {
    ...
    pasteLead: 'Instagram’daki yemek videosunun ya da bir tarif sitesinin bağlantısını yapıştır; tarife çevirelim.',
    pasteLabel: 'Instagram ya da tarif sitesi bağlantısı',
    ...
    pasteStep0: 'Videoyu Instagram’da, tarif sayfasını tarayıcında aç.',
    pasteStep1: '⋯ menüsüne (Instagram) ya da adres çubuğuna dokun, bağlantıyı kopyala.',
    ...
    pasteEntryHint: 'Instagram ya da tarif sitesi bağlantısı yapıştır',
