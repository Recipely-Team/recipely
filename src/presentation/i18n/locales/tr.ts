...
export const tr: Translations = {
  ...
  recipes: {
    ...
    originAiTooltip: 'Yapay zekâ bu tarifi bir istemden yazdı.',
    originAiA11y: 'Yapay zekâ ile yazılmış tarif',
    originAiDetailLabel: 'Yapay zekâ ile yazılmış tarif',
    originImportTooltip: 'Bir Instagram gönderisinden alındı.',
    originImportA11y: "Instagram'dan alındı",
    originImportDetailLabel: "Instagram'da {handle} hesabından alındı",
    originImportHandleA11y: "Instagram'da {handle} hesabını aç",
