export const en = {
  ...
  importRecipe: {
    ...
    estimate: 'Estimated',
    estimateValue: '~2 min',
    pasteTitle: 'Import from Instagram',
    pasteLead: 'Copy the link to a cooking post or reel, paste it below, and we’ll turn the video into a recipe.',
    ...
    pasteStep0: 'Open the post or reel in Instagram.',
    pasteStep1: 'Tap the ⋯ menu and choose Copy link.',
