export const en = {
  ...
  errors: {
    ...
    importInvalidUrl: {
      ...
      body: 'Paste a valid Instagram, TikTok or recipe website link and try again.',
      short: 'Paste a valid Instagram, TikTok or recipe website link',
    },
    importNotInstagram: {
      title: "We can't import from there",
      body: 'Imports work with Instagram and TikTok videos and recipe websites.',
      short: "We can't import from that site",
    },
    importFetchFailed: {
    ...
    importNoRecipeOnPage: {
      ...
      body: "That page doesn't publish a recipe we can read. Try the recipe's own page on the site.",
      short: 'No recipe found on that page',
    },
    importPageUnreachable: {
      title: "We couldn't open that page",
      body: "We couldn't open that page. Check the link and try again.",
      short: "Couldn't open that page",
    },
    importBusy: {
    ...
    importNoFile: {
      title: 'Add a page first',
      body: 'Add a photo or a PDF of the recipe.',
      short: 'Add a photo or a PDF',
    },
    importUnsupportedFile: {
      title: 'We can\'t read that file',
      body: 'That file type can\'t be read. Use photos (JPEG, PNG, HEIC) or a PDF.',
      short: 'That file type can\'t be read',
    },
    importTooManyFiles: {
      title: 'Too many files',
      body: 'Up to 5 photos, or one PDF on its own.',
      short: 'Up to 5 photos, or one PDF',
    },
    importNoRecipeInFile: {
      title: 'No recipe found',
      body: 'We read the pages but found no recipe on them. Try a clearer photo of the recipe.',
      short: 'No recipe found in this file',
    },
    importUnreadableFile: {
      title: 'We couldn\'t open that file',
      body: 'We couldn\'t open that file. Try another photo or PDF.',
      short: 'Couldn\'t open that file',
    },
    recipeExists: {
    ...
    photoRejected: {
      ...
      short: 'Photo not allowed',
    },
    photoUnchecked: {
      title: 'Couldn\'t check that photo',
      body: 'We couldn\'t review it just now. Give it another go in a moment.',
      short: 'Photo check failed',
    },
    publishRejected: {
      title: "Not approved",
      body: "This recipe didn't pass review, so it can't be published again. It stays private.",
      short: "Not approved — stays private",
    },
    publishBlockedCopyright: {
      title: "Make it your own first",
      body: "Recipes from websites are shared with your own photo and your own words. Check the list on the recipe.",
      short: "Needs your own photo and words",
    },
    editPublished: {
      title: "Make it private to edit",
      body: "Published recipes can't be changed. Make it private, edit it, then publish again.",
      short: "Make it private to edit",
    },
    photoNotFound: {
      title: "Photo not found",
      body: "That photo is no longer on this recipe.",
      short: "Photo not found",
    },
    nothingToEdit: {
  ...
  recipes: {
    ...
    photoAddFailed: 'That photo couldn\'t be added.',
    ...
    originInstagramHandleA11y: 'Open the video by {handle} on Instagram',
    originTiktokHandleA11y: 'Open the video by {handle} on TikTok',
    ...
    cuisineAll: 'All',
    webAllRecipes: 'All recipes',
    webSearchResults: 'Search results',
    webCuisineRecipes: '{cuisine} recipes',
    webRecipesCount: '{n} recipes',
    difficultyAll: 'All',
    difficultyEasy: 'Easy',
  ...
  support: {
    ...
    sendFeedback: 'Send a message',
    sheetTitle: 'Help & Feedback',
    subtitle: "Found a bug or need a hand? Send us a title and a message and we'll take a look.",
    subject: 'Title',
    subjectPlaceholder: 'Brief summary',
    message: 'Message',
    messagePlaceholder: 'Describe the issue or your request…',
    send: 'Send',
    sending: 'Sending…',
    cancel: 'Cancel',
    error: "Couldn't send your message. Please try again.",
    sentTitle: 'Message sent',
    sentSub: "Thanks for reaching out — we'll get back to you soon.",
    sentDone: 'Done',
  },
  navigation: {
    recipes: 'Recipes',
  ...
  publishing: {
    privateNote: "Only you can see this recipe",
    inReviewNote: "In review — this usually doesn't take long",
    publishedNote: "Everyone can see it in the feed",
    rejectedTitle: "This recipe wasn't approved",
    rejectedNote: "It stays private",
    publish: "Publish",
    edit: "Edit",
    makePrivate: "Make private",
    unpublish: "Unpublish",
    unpublishTitle: "Unpublish this recipe?",
    unpublishMessage: "It leaves the feed and only you can see it.",
    makePrivateTitle: "Make this recipe private?",
    makePrivateMessage: "It leaves review and only you can see it.",
    checklistIntro: "Recipes from websites are shared with your own photo and your own words.",
    needPhoto: "Add your own photo",
    needIngredients: "Put the ingredients in your own words",
    needInstructions: "Put the steps in your own words",
    addPhoto: "Add photo",
    removeSitePhoto: "Remove site photo",
    thingsLeft: "{n} things left",
    oneThingLeft: "1 thing left",
    toastPublished: "Published — it's in the feed now",
    toastInReview: "Sent for review",
    toastRejected: "Not approved — it stays private",
    toastPrivate: "It's private again",
    sitePhotoRemoved: "Site photo removed",
  ...
  myRecipes: {
    ...
    emptyLiked: 'No liked recipes yet. Tap the heart on a recipe and it shows up here.',
  ...
  createRecipe: {
    ...
    emptyGroup: 'No ingredients in this group yet.',
    deleteGroup: 'Delete group',
    deleteQuestion: 'Delete this group?',
    keepItems: 'Keep ingredients',
    keepItemsHint: 'Ungroups them',
    deleteAll: 'Delete group and its ingredients',
    moveUp: 'Move up',
    moveDown: 'Move down',
    ...
    saving: "Saving…",
    savedPrivately: "Saved to your recipes. Only you can see it.",
    ...
    proposalWaiting: 'A change is waiting for your approval',
    changeEmptyValue: 'not set',
    changeFields: {
      name: 'Name',
      cuisine: 'Cuisine',
      category: 'Category',
    ...
    exitDiscard: 'Discard',
    editExitTitle: "Save your changes?",
    editExitBody: "You changed this recipe. Save the changes, or leave it as it was.",
    editExitDiscard: "Discard changes",
  ...
  importRecipe: {
    ...
    ready: 'Recipe ready',
    readyBody: 'Your recipe is now a draft, waiting in My Recipes.',
    stage0: 'Downloading the video',
    stage1: 'Transcribing the audio',
    ...
    estimate: 'Estimated',
    estimateValue: '~2 min',
    pasteTitle: 'Import a recipe',
    pasteLead: 'Paste a link to a cooking video on Instagram or TikTok, or to a recipe website, and we’ll turn it into a recipe.',
    pasteLabel: 'Instagram, TikTok or recipe website link',
    pastePlaceholder: 'Paste a video or recipe page link',
    pasteAction: 'Paste',
    pasteSubmit: 'Import recipe',
    pasteHowTo: 'How to get the link',
    pasteStep0: 'Open the video in Instagram or TikTok, or the recipe page in your browser.',
    pasteStep1: 'Tap Share (TikTok), the ⋯ menu (Instagram) or the address bar, then copy the link.',
    pasteStep2: 'Come back here and paste it.',
    pasteNote: 'Works with public videos under 90 seconds and most recipe sites.',
    pasteEmpty: 'Paste a link first.',
    pasteRecognised: 'Link recognised',
    pasteManual: 'Paste the link into the field.',
    pasteEntry: 'Import a recipe',
    pasteEntryHint: 'Paste an Instagram, TikTok or recipe website link',
    failTitle: 'Import failed',
    pasteDetectedInstagram: 'Instagram link',
    pasteDetectedTiktok: 'TikTok link',
    pasteDetectedWeb: 'Recipe website: {host}',
    webTitle: 'Reading the recipe from {host}',
    webBody: 'Recipe sites publish their recipe in a structured form, so this takes a few seconds. No video to watch.',
    webReading: 'Reading',
    webSite: 'Site',
  ...
  fileImport: {
    entry: 'Read from a photo or PDF',
    entryHint: 'Cookbook page, handwritten card or screenshot',
    title: 'Recipe from a file',
    ...
    choose: 'Choose files',
    dropNow: 'Drop to add',
    formats: 'JPG, PNG or HEIC up to 10 MB each · one PDF up to 10 MB',
    formatsPhotos: 'JPG, PNG or HEIC, up to 10 MB each',
    pages: 'Pages',
    addPage: 'Add page',
    order: 'Tap a page to move or remove it. Page 1 is read first.',
    page: 'Page {n}',
    pageCount: '{n} / {max}',
    ...
    pdfLabel: 'PDF',
    submit: 'Read recipe',
    note: 'The draft opens in the editor. Saving keeps it private.',
    addSheet: 'Add a page',
    readTitle: 'Reading your recipe',
    readBody: 'AI is reading {what} and writing it up as a draft. This usually takes 10–30 seconds.',
    yourPhoto: 'your photo',
    yourPhotos: 'your {n} photos',
    yourPdf: 'your PDF',
    stage0: 'Uploading your pages',
    stage1: 'Reading the text',
    stage2: 'Finding ingredients and steps',
    stage3: 'Writing your draft',
    statPages: 'Pages',
    estimateValue: '~20 sec',
  ...
  timer: {
    ...
    cancel: 'Cancel',
    stop: 'Stop timer',
    alreadyRunning: 'A timer is already running for this recipe. Stop it before starting another.',
  ...
  onboarding: {
    ...
    dontShow: "Don't show this page again",
    discover: 'Discover',
    slideLabel: 'Go to slide',
    previousSlide: 'Previous',
    nextSlide: 'Next',
    slides: {
      recipesEyebrow: '1000+ recipes',
      recipesTitle: 'Thousands of tried\nrecipes, in seconds',
      recipesBody:
        'Easy, practical, tried-and-tested recipes — in your pocket whenever you need them.',
      aiEyebrow: 'AI powered',
      aiTitle: 'Type what you have,\nget a full recipe',
      aiBody:
        'Tell Recipely what you have on hand and get a recipe made just for you in seconds.',
      timerEyebrow: 'Smart kitchen',
      timerTitle: 'Cook step by step,\nwith timers',
      timerBody:
        'Steps split into tasks and smart timers so you never miss a beat in the kitchen.',
    },
    mock: {
      searchPlaceholder: 'Search recipes…',
      recipeOneTitle: 'Lemon Roast Chicken',
      recipeOneMeta: 'Mediterranean · 35 min',
      recipeTwoTitle: 'Creamy Mushroom Pasta',
      recipeTwoMeta: 'Italian · 20 min',
      aiTitle: 'Generate with AI',
      aiCreate: 'Create recipe',
      aiChipOne: 'Chicken',
      aiChipTwo: 'Lemon',
      aiChipThree: 'Garlic',
      aiChipFour: 'Thyme',
      timerLabel: 'Bake',
      stepOne: 'Preheat oven',
      stepTwo: 'Marinate chicken',
      stepThree: 'Bake',
    },
  },
  assistant: {
    ...
    send: "Send",
    empty: "Ask me to cook something.",
    outOfMinutes: "You have used today's voice minutes. You can keep typing.",
    ...
    unsaveMessage: "It leaves your saved list — you can save it again later.",
    unsaveConfirm: "Remove",
    ...
    suggestions: [
      ...
      "Create a lentil soup recipe",
      "Open my saved recipes",
      "Add a vegetarian filter",
    ],
    actions: {
      navigate: "Opened the page",
      goBack: "Went back",
      openRecipe: "Opened the recipe",
      openDraft: "Opened the draft",
      deleteDraft: "Deleted the draft",
      switchTab: "Switched tab",
      refresh: "Refreshed",
      search: "Searched",
      addFilter: "Added a filter",
      removeFilter: "Removed a filter",
      clearFilters: "Cleared the filters",
      sort: "Changed the sorting",
      confirm: "Confirmed",
      cancel: "Cancelled",
      save: "Saved",
      ...
      generateRecipe: "Created a recipe",
      setDraftField: "Filled in a field",
      addIngredient: "Added an ingredient",
      removeIngredient: "Removed an ingredient",
      addStep: "Added a step",
      removeStep: "Removed a step",
      attachPhoto: "Added a photo",
      refineDraft: "Edited the draft",
      regenerate: "Generated it again",
      publishDraft: "Published the recipe",
      deleteRecipe: "Deleted the recipe",
      shareRecipe: "Shared the recipe",
      duplicateRecipe: "Copied the recipe",
      addComment: "Wrote a comment",
      ...
      startTimer: "Started a timer",
      pauseTimer: "Paused the timer",
      resumeTimer: "Resumed the timer",
      stopTimer: "Stopped the timer",
      readStep: "Read the step out",
      readIngredients: "Read the ingredients",
      readScreen: "Read the screen out",
      reportProblem: "Sent a problem report",
