export const en = {
  ...
  errors: {
    ...
    importInvalidUrl: {
      ...
      body: 'Paste a valid Instagram or recipe website link and try again.',
      short: 'Paste a valid Instagram or recipe website link',
    },
    importNotInstagram: {
      title: "We can't import from there",
      body: 'Imports work with Instagram videos and recipe websites.',
  ...
  importRecipe: {
    ...
    pasteLead: 'Paste a link to a cooking video on Instagram, or to a recipe website, and we’ll turn it into a recipe.',
    pasteLabel: 'Instagram or recipe website link',
    pastePlaceholder: 'Paste a video or recipe page link',
    pasteAction: 'Paste',
    pasteSubmit: 'Import recipe',
    pasteHowTo: 'How to get the link',
    pasteStep0: 'Open the video in Instagram, or the recipe page in your browser.',
    pasteStep1: 'Tap the ⋯ menu (Instagram) or the address bar, then copy the link.',
    ...
    pasteEntryHint: 'Paste an Instagram or recipe website link',
