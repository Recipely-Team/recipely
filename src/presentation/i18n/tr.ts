...
export const tr: Translations = {
  ...
  support: {
    section: 'Yardım & Geri Bildirim',
    sendFeedback: 'Mesaj gönder',
    sheetTitle: 'Yardım & Geri Bildirim',
  ...
  onboarding: {
    ...
    slides: {
      ...
      recipesBody:
        'Kolay, pratik ve denenmiş binlerce tarif; ihtiyacınız olan her an cebinizde.',
      aiEyebrow: 'Yapay zeka',
