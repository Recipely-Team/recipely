...
export const tr: Translations = {
  ...
  login: {
    title: 'Recipely',
    subtitle: 'Tariflerini görmek için giriş yap.',
  ...
  recipes: {
    ...
    noResults: 'Aramanla eşleşen tarif bulunamadı.',
    servings: 'Porsiyon',
    saved: 'Kaydedildi',
    save: 'Kaydet',
    filter: 'Filtrele',
  ...
  support: {
    ...
    subtitle: 'Bir hata mı buldun ya da yardıma mı ihtiyacın var? Bir başlık ve mesaj gönder, en kısa sürede bakalım.',
    subject: 'Başlık',
  ...
  myRecipes: {
    ...
    emptySaved: 'Henüz kaydettiğin tarif yok. Beğendiğin tarifleri kaydet, hepsi burada toplansın.',
  ...
  createRecipe: {
    title: 'Tarif oluştur',
    comingSoon: 'Yapay zekâ destekli tarif oluşturma yakında.',
    name: 'Tarif adı',
    ...
    aiHeroSub: 'Ne istediğini anlat — yapay zekâ tarifin taslağını çıkarsın. Aşağıda gözden geçirip yayınlayabilirsin.',
    ideaChips: [
    ...
    aiPromptFailed: 'Bu istekten tarif oluşturulamadı. Farklı bir şekilde anlatıp tekrar dene.',
    aiUpdated: 'Güncellendi!',
    aiThinking: 'Düşünüyor…',
    aiFirstReply: 'Tarifin hazır! İstediğin değişikliği söyle.',
    aiSavedDraft: 'Bu bir yapay zekâ taslağı. Yayınlayınca Tariflerim’e kaydedilecek.',
    ...
    aiUnavailable: 'Yapay zekâ ile tarif oluşturma şu an kullanılamıyor.',
    media: 'Fotoğraflar',
    next: 'İleri',
    back: 'Geri',
    done: 'Tamam',
    ...
    promptSub: 'Bir yemek, bir istek ya da bir kısıt anlat — yapay zekâ tüm tarifi hazırlasın. Sonra her ayrıntıyı düzenleyebilirsin.',
    ...
    genSub: 'Yapay zekâ şef her şeyi senin için tabağa diziyor.',
  ...
  importRecipe: {
    ...
    title: 'Aldık, işliyoruz',
    body: 'Reel’in sıraya girdi. Videodan tarif çıkarmak bir iki dakika sürüyor — uygulamayı kapatabilirsin, hazır olduğu anda sana bildirim göndereceğiz.',
    queued: 'Sıraya alındı',
    working: 'İşleniyor',
    ready: 'Tarif hazır',
    readyBody: 'Reel’in artık bir taslak — Tariflerim’de seni bekliyor.',
    ...
    background: 'Arka planda devam eder',
    estimate: 'Tahmini',
    estimateValue: '~2 dk',
  ...
  timer: {
    ...
    alreadyRunning: 'Bu tarifte zaten bir zamanlayıcı çalışıyor. Yenisini başlatmak için önce onu durdur.',
  ...
  notifications: {
    ...
    all: 'Tümü',
    unread: 'Okunmamış',
    empty: 'Tüm bildirimleri gördün.',
    today: 'Bugün',
    yesterday: 'Dün',
    earlier: 'Daha önce',
    daysShort: '{n}g',
    commented: 'şu tarife yorum yaptı:',
    liked: 'şu tarifi beğendi:',
    saved: 'şu tarifi kaydetti:',
    ...
    modPending: 'şu tarif incelemede:',
  ...
  profile: {
    ...
    addBioPrompt: 'Profilini düzenleyip “Hakkında” bölümüne mutfağınla ilgili kısa bir not ekle.',
    today: 'Bugün',
    daysAgo: 'gün önce',
    ...
    activityAi: 'Yapay zekâ ile 3 tarif oluşturuldu',
  ...
  onboarding: {
    signUp: 'Üye ol',
    signIn: 'Giriş yap',
    explore: 'Giriş yapmadan keşfetmeye başla',
    ...
    slides: {
      ...
      timerBody:
        'Göreve bölünmüş adımlar ve akıllı zamanlayıcılarla mutfakta hiçbir anı kaçırma.',
    },
    mock: {
      searchPlaceholder: 'Tarif ara…',
