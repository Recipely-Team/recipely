...
export interface LinkImportFlowProps {
  /** The shared link to queue straight away; undefined asks for one. */
 ...
 *
 * @remarks
 * - **Arriving with a link queues straight away**; arriving without one asks
 *   for it.
 ...
 */
export const LinkImportFlow = ({ importUrl }: LinkImportFlowProps): React.JSX.Element => {
