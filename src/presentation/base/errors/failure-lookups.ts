...
const KEY_TO_SEVERITY: Partial<Record<FailureContentKey, SeverityType>> = {
  ...
  importNoFile: SeverityType.Neutral,
  importTooManyFiles: SeverityType.Warning,
  importNoRecipeInFile: SeverityType.Neutral,
...
const KEY_TO_ICON: Partial<Record<FailureContentKey, IoniconName>> = {
  ...
  importNoFile: 'add-circle-outline',
  importUnsupportedFile: 'ban-outline',
  importTooManyFiles: 'layers-outline',
