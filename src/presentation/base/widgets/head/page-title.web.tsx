 ...
 * - **Web only, and the native half is not an oversight.** `expo-router/head`
 *   on iOS registers a Handoff activity instead of a title, and alerts in a
 *   release build when no `origin` is configured. See `page-title.tsx`.
