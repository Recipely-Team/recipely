...
[architecture.md](architecture.md). 1006 source files.
...
- `onboarding/` _(2)_
- `recipes/` — create, delete, detail, generate, import, liked, list, my-recipes, photos, refine, saved, taxonomy, trending _(46)_
- `storage/` _(2)_
- `store/` _(2)_
- `timers/` _(7)_
- `user-profile/` _(5)_
