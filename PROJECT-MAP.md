...
[architecture.md](architecture.md). 912 source files.
...
- `hooks/` (ads, assistant, auth, interaction, navigation, notifications, profile, recipes, sync, timers) — shared hooks, grouped by capability _(28)_
