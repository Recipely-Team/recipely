...
[architecture.md](architecture.md). 782 source files.
...
- `onboarding/` _(2)_
- `recipes/` — create, delete, detail, generate, import, list, my-recipes, refine, saved, taxonomy, trending _(42)_
- `storage/` _(2)_
- `store/` _(2)_
- `timers/` _(7)_
- `user-profile/` _(5)_
