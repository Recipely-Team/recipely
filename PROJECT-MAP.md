...
[architecture.md](architecture.md). 790 source files.
...
- `onboarding/` _(2)_
- `recipes/` — create, delete, detail, generate, import, list, my-recipes, refine, saved, taxonomy, trending _(41)_
- `storage/` _(2)_
- `store/` _(2)_
- `timers/` _(7)_
- `user-profile/` _(5)_
...
- `errors/` — Failure → user-facing copy/severity lookups _(8)_
...
- `widgets/` (brand, buttons, cards, dialogs, feedback, inputs, layout, lists, loading, media, navigation, settings, sheets, text, timers, web-header) — shared components, grouped by category _(45)_
