...
[architecture.md](architecture.md). 950 source files.
...
- `ads/` _(1)_
- `assistant/` — actions, audio, session _(17)_
- `audio/` _(1)_
- `auth/` _(7)_
- `comments/` _(4)_
- `common/` _(1)_
...
- `hooks/` (accessibility, ads, assistant, auth, interaction, navigation, notifications, profile, recipes, sync, timers) — shared hooks, grouped by capability _(36)_
...
- `widgets/` (ads, assistant, brand, buttons, cards, dialogs, feedback, inputs, layout, lists, loading, media, navigation, settings, sheets, text, timers, web-header) — shared components, grouped by category _(75)_
