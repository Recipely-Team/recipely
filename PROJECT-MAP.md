...
[architecture.md](architecture.md). 1010 source files.
...
- `widgets/` (ads, assistant, brand, buttons, cards, dialogs, feedback, head, inputs, layout, lists, loading, media, navigation, settings, sheets, text, timers, web-header) — shared components, grouped by category _(87)_
