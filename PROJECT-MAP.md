...
[architecture.md](architecture.md). 1031 source files.
...
- `ads/` _(1)_
- `analytics/` _(1)_
- `assistant/` — actions, audio, os, session _(27)_
- `audio/` _(1)_
- `auth/` _(7)_
- `comments/` _(4)_
- `common/` _(1)_
...
- `hooks/` (accessibility, ads, assistant, auth, interaction, navigation, notifications, profile, recipes, sync, timers) — shared hooks, grouped by capability _(62)_
