...
[architecture.md](architecture.md). 736 source files.
...
- `network/` _(2)_
- `notifications/` _(7)_
- `recipes/` — create, ingredients, list, media, refine, taxonomy _(21)_
- `storage/` _(1)_
- `user-profile/` _(2)_
...
- `i18n/` _(1)_
- `likes/` _(1)_
- `network/` — envelope, errors, http, jwt, upload _(20)_
