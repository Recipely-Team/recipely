...
[architecture.md](architecture.md). 948 source files.
...
- `widgets/` (ads, assistant, brand, buttons, cards, dialogs, feedback, inputs, layout, lists, loading, media, navigation, settings, sheets, text, timers, web-header) — shared components, grouped by category _(76)_
