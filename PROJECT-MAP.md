...
[architecture.md](architecture.md). 997 source files.
...
- `hooks/` (accessibility, ads, assistant, auth, interaction, navigation, notifications, profile, recipes, sync, timers) — shared hooks, grouped by capability _(58)_
