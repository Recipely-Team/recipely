...
[architecture.md](architecture.md). 947 source files.
...
- `ads/` _(2)_
- `assistant/` — actions, session _(8)_
- `audio/` _(2)_
...
- `hooks/` (accessibility, ads, assistant, auth, interaction, navigation, notifications, profile, recipes, sync, timers) — shared hooks, grouped by capability _(34)_
