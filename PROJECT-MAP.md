...
[architecture.md](architecture.md). 928 source files.
...
- `ads/` _(1)_
- `assistant/` — actions, audio, session _(16)_
- `audio/` _(1)_
- `auth/` _(7)_
- `comments/` _(4)_
- `common/` _(1)_
...
- `hooks/` (ads, assistant, auth, interaction, navigation, notifications, profile, recipes, sync, timers) — shared hooks, grouped by capability _(32)_
