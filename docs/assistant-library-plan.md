...
- [ ] **Resume here (2026-09-11, stopped for the usage limit):**
  ...
  - [ ] Still to check live: reading a recipe's steps out loud ("yapılışını okuyamadı") — measure with a temporary `__DEV__` log of `{args, result}` in `assistant-live-tool.ts`
